	...
	public function initPage( OutputPage $out ) {
		...
		$out->addHeadItem( 'csshover',
			'<!--[if lt IE 7]><style type="text/css">body{behavior:url("' .
				...
				"/skins/Synagonism/modules/csshover{$min}.htc\")}</style><![endif]-->"
		);
...
class SynagonismTemplate extends BaseTemplate {
	...
	public function execute() {
		...
		if ( $wgVectorUseIconWatch ) {
			$mode = $this->skin->getUser()->isWatched( $this->skin->getTitle() ) ? 'unwatch' : 'watch';
...
<?php
	...
	private function renderNavigation( $elements ) {
		global $wgVectorUseSimpleSearch, $wgVectorShowVariantName, $wgUser, $wgLang, $wgExtensionAssetsPath;
...
<div id="p-search" class="noprint">
	...
	<form action="<?php $this->text( 'wgScript' ) ?>" id="searchform">
		...
		<div id="simpleSearch">
			...
			<?php echo $this->makeSearchButton( 'image', array( 'id' => 'searchButton', 'src' => $wgExtensionAssetsPath . '/skins/Synagonism/modules/images/search-rtl.png' ) ); ?>
			<?php endif; ?>
			<?php echo $this->makeSearchInput( array( 'id' => 'searchInput', 'type' => 'text' ) ); ?>
			<?php if ( !$this->data['rtl'] ): ?>
			<?php echo $this->makeSearchButton( 'image', array( 'id' => 'searchButton', 'src' => $wgExtensionAssetsPath . '/skins/Synagonism/modules/images/search-ltr.png' ) ); ?>
			<?php endif; ?>
		</div>
		<?php else: ?>
